...
export default function Responsive_JSE() {
        ...
        <div className="w-full flex flex-col xl:flex-row text-center justify-center items-center xl:items-start py-4 xss:py-6 xs:py-8 sm:py-10 xl:py-3 3xl:py-24 bg-white">
          ...
          <div className="w-full xl:w-1/2 flex flex-col justify-start items-start px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 mt-6 xl:mt-0 xl:h-[530px] lg:h-[450px] 3xl:h-[570px] overflow-y-auto scrollbar-hide max-h-[calc(100vh-200px)]">
            ...
            <div className="self-start">
              <Image
                src="/SingleProd-Images/Logo-JSE.svg"
                width={250}
                height={200}
                alt="LogoImage"
            ...
            <div className="w-full xl:w-2/3 mt-6">
              ...
              <p className="text-[#7B7E86] w-full text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-start mt-3 leading-5 sm:leading-6 mr-8 md:mr-15">
                Jayasindoor is a devotional music streaming app offering bhajans, mantras, and spiritual content on demand.
 It is your ultimate devotional music app, offering ad-free streaming, unlimited downloads, and a rich library of spiritual songs. From soothing bhajans to uplifting chants, it brings you high-quality audio and curated playlists for every spiritual occasion. With an easy-to-use interface, Jayasindoor makes your divine musical journey seamless and soulful.
              </p>
            </div>
          </div>
        </div>
