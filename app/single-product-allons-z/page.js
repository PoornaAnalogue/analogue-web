...
export default function Responsive_Allons() {
      ...
      <div className="w-full bg-white">
        ...
        <div className="w-full flex flex-col xl:flex-row text-center justify-center items-center xl:items-start py-4 xss:py-6 xs:py-8 sm:py-10 xl:py-3 3xl:py-24 bg-white">
          ...
          <div className=" w-full xl:w-1/2 flex justify-center items-center px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-5 ">
            <Image
              src="/SingleProd-Images/allons-z.png"
              width={650}
              height={280}
              alt="Combine image"
          ...
          <div className="w-full xl:w-1/2 flex flex-col justify-start items-start px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 mt-6 xl:mt-0 xl:h-[530px] lg:h-[450px] 3xl:h-[570px] overflow-y-auto scrollbar-hide">
            ...
            <div className="self-start">
              <Image
                src="/SingleProd-Images/Logo-allonz.svg"
                width={250}
                height={200}
                alt="LogoImage"
            ...
            <div className="w-full xl:w-2/3 mt-6">
              ...
              <p className="text-[#7B7E86] w-full text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-start mt-3 leading-5 sm:leading-6 mr-8 md:mr-15">
                Allons-z is a travel referral and tourism app that connects users through a social circle for seamless trip planning. It is a travel referral platform that connects users in a referral circle system, allowing them to explore destinations, services, and offers through trusted recommendations. By fostering a connected community, Allonsz promotes authentic travel experiences and incentivizes sharing through rewards and perks. The platform&apos;s linked-circle structure ensures scalable growth, simplifies travel decisions, and builds a network of reliable, user-driven travel insights.
              </p>
            </div>
          </div>
        </div>
