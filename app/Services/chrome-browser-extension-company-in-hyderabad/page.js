...
export default function ChromeExtension() {
  ...
  const DesignIcons = [
    "/service-icons/Figma-logo.png",
    "/service-icons/Png-logo.png",
    "/service-icons/Ai-logo.png",
    "/service-icons/Jitter-logo.png",
    "/service-icons/Lottiefiles-logo.png",
    "/service-icons/Search-logo.png",
  ];
    ...
    <>
      <div className="hero flex flex-col justify-center items-center bg-white">
        ...
        <div className="px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-16 xl:px-20 flex flex-col space-y-4">
          <h1 className="text-lg xss:text-md xs:text-lg sm:text-xl md:text-2xl lg:text-2xl 3xl:text-[1.6rem] font-semibold underline xss:underline-offset-6 lg:underline-offset-14 xss:underline-offset-1 text-black xs:underline-offset-12 sm:underline-offset-10 md:underline-offset-15 decoration-2 xss:decoration-2 xs:decoration-2 sm:decoration-4 md:decoration-4 lg:decoration-4 decoration-blue-600 leading-snug">
            Chrome Extension
          </h1>
          <h3 className="NewFont text-base xss:text-[0.8rem] sm:text-base md:text-lg lg:text-xl 3xl:text-2xl text-blue-500 font-medium leading-snug mt-2 xss:mt-3 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">
            We are the best Chrome Browser Extension Development Company in
            Hyderabad, India
          </h3>
          <p className="text-gray-500 leading-relaxed text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base mt-2 xss:mt-1 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">
          ...
          <p className="text-gray-500 leading-relaxed text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base mt-2 xss:mt-3 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">
            Analogue is a Best mobile app development company in Hyderabad that
            specialises in creating and enhancing user experience through the
            design and development of mobile and web applications. Our focus
            lies in helping businesses expand and reach their specific customer
        ...
        <div className="mt-4 xss:mt-6 xs:mt-8 sm:mt-10 md:mt-12 lg:mt-15">
          <div className="relative w-full h-auto min-h-[200px] xss:min-h-[250px] xs:min-h-[200px] sm:min-h-[350px] md:min-h-[400px] lg:h-[400px] bg-[url('/service-icons/app-dev-bg.jpg')] bg-cover bg-center flex flex-col lg:flex-row justify-end items-center">
            <div className="w-full lg:w-[48%] 2xl:w-[50%] lg:absolute lg:inset-y-0 lg:left-0 p-4 xss:p-6 xs:p-8 sm:p-10 md:p-12 lg:p-11 xl:p-9 2xl:p-10">
              <h1 className="text-white text-lg xss:text-md xs:text-lg sm:text-xl md:text-2xl lg:text-2xl 3xl:text-[1.6rem] font-bold  xss:leading-tight 2xl:leading-loose">
        ...
        <div className="leading-relaxed p-4 xss:p-6 xs:p-8 sm:p-10 md:p-12 lg:p-16 xl:p-20">
          <h1 className="text-blue-700 font-semibold text-lg xss:text-lg xs:text-lg sm:text-2xl md:text-2xl lg:text-2xl w-full leading-loose">
          ...
          <h1 className="text-blue-700 font-semibold text-lg xss:text-lg xs:text-lg sm:text-2xl md:text-2xl lg:text-2xl leading-loose mt-4 xss:mt-5 xs:mt-6 sm:mt-6 md:mt-7 lg:mt-7">
          ...
          <div className="flex flex-wrap gap-4 xss:gap-4 xs:gap-5 sm:gap-5 md:gap-6 lg:gap-6 mt-2 xss:mt-3 xs:mt-4 sm:mt-4 md:mt-5 lg:mt-5">
            {DesignIcons.map((item, index) => (
              <Image
                ...
                height={
                  index === 0 || index >= DesignIcons.length - 2 ? 20 : 40
                }
                className="object-contain w-[20px] h-[20px] xss:w-[25px] xss:h-[25px] sm:w-[25px] sm:h-[25px] md:w-[25px] md:h-[25px] lg:w-[35px] lg:h-[35px]"
              />
            ))}
          </div>
          <p className="text-gray-500 text-xs xss:text-xs xs:text-xs sm:text-sm md:text-sm lg:text-subbody 3xl:text-base lg:leading-6 mt-4 xss:mt-6 xs:mt-8 sm:mt-8 md:mt-10 lg:mt-10">
            Analogue is a Best mobile app development company in Hyderabad that
            specialises in creating and enhancing user experience through the
            design and development of mobile and web applications. Our focus
            lies in helping businesses expand and reach their specific customer
