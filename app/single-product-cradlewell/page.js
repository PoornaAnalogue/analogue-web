...
export default function Responsive_carecradle() {
  ...
  return (
    <>
      <div className="w-full bg-white">
        ...
        {/* Product Title */}
        <div className="font-semibold text-2xl xss:text-xl sm:text-2xl md:text-[1.7rem]  3xl:text-4xl text-[#071637] px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 py-4 xss:py-5 sm:py-6 xl:py-8  bg-white underline underline-offset-8 xss:underline-offset-10 sm:underline-offset-12 md:underline-offset-15 decoration-blue-500 decoration-4">
          <p>Cradlewell</p>
        </div>

        {/* Main Content */}
        <div className="w-full flex flex-col xl:flex-row text-center justify-center items-center xl:items-start py-4 xss:py-6 xs:py-8 sm:py-10 xl:py-3 3xl:py-10 bg-white">
          {/* Image Section */}
          <div className=" w-full xl:w-1/2 flex justify-end items-center px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-5 ">
            <Image
              src="/SingleProd-Images/carecradle.png"
              width={650}
              height={280}
              alt="Combine image"
              className=" object-contain w-full max-w-[250px] xss:max-w-[280px] xs:max-w-[300px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[500px] xl:max-w-[500px] 2xl:max-w-[550px] 3xl:max-w-[620px]"
            />
          </div>
          ...
          <div className="w-full xl:w-1/2 flex flex-col justify-start items-start px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 mt-6 xl:mt-0 xl:h-[530px] lg:h-[450px] 3xl:h-[570px] overflow-y-auto scrollbar-hide max-h-[calc(100vh-200px)]">
            ...
            <div className="self-start">
              <Image
                src="/SingleProd-Images/Logo-carecradle.svg"
                width={250}
                height={200}
                alt="LogoImage"
                className="w-[150px] xss:w-[100px] sm:w-[120px] md:w-[120px] lg:w-[130px] xl:w-[140px] 2xl:w-[180px] h-auto"
              />
            </div>
            ...
            <div className="w-full xl:w-2/3 mt-6">
              ...
              <p className="text-[#7B7E86] w-full text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-start mt-3 leading-5 sm:leading-6 mr-8 md:mr-15">
                 Cradlewell is a healthcare app delivering trusted postnatal support and newborn care services at home.
 It offers premium in-home postnatal care with certified nurses, personalized support plans, and flexible scheduling. From daily recovery assistance to overnight care, it ensures holistic well-being for both mother and baby. With vetted professionals and continuous guidance via WhatsApp, Cradlewell brings trusted, compassionate care right to your doorstep.
              </p>
            </div>
          </div>
        </div>
