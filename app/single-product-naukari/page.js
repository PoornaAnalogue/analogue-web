...
export default function Responsive_Naukari() {
            ...
            <div className="w-full bg-white">
                ...
                <div className="w-full flex flex-col xl:flex-row text-center justify-center items-center xl:items-start py-4 xss:py-6 xs:py-8 sm:py-10 xl:py-3 3xl:py-24 bg-white">
                    ...
                    <div className=" w-full  xl:w-1/2 flex justify-center items-center px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-5">
                        <Image
                            src="/SingleProd-Images/naukari.png"
                            width={650}
                            height={280}
                            alt="Combine image"
                    ...
                    <div className="w-full xl:w-1/2 flex flex-col justify-start items-start px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 mt-6 xl:mt-0 xl:h-[530px] lg:h-[450px] 3xl:h-[570px] overflow-y-auto scrollbar-hide">
                        ...
                        <div className="self-start">
                            <Image
                                src="/SingleProd-Images/Logo-naukari.png"
                                width={250}
                                height={200}
                                alt="LogoImage"
                                className="w-[150px] xss:w-[140px] lg:w-[110px] xl:w-[110px] 2xl:w-[140px] h-auto"
                            />
                        </div>
                        ...
                        <div className="w-full xl:w-2/3 mt-6">
                            ...
                            <p className="text-[#7B7E86] w-full text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-start mt-3 leading-5 sm:leading-6 mr-8 md:mr-15">
                                ...
                                IT-Naukari is an educational technology app supporting career development with learning and job opportunities.
 It is a career and learning platform that bridges aspiring IT professionals with industry opportunities. Combining personalized learning paths, industry-relevant courses, hands-on projects, and career placement support, it ensures learners gain practical skills and secure meaningful jobs. By fostering continuous growth through mentorship and a connected learning community, IT-Naukari transforms IT upskilling and recruitment.                            </p>
                        </div>
                    </div>
