...
export default function SingleProductPagetest2res() {
  return (
    <>
      <div className="w-full bg-white">
        ...
        {/* Product Title */}
        <div className="font-semibold text-2xl xss:text-2xl xs:text-3xl   3xl:text-9xl text-[#071637] px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 py-4 xss:py-5 sm:py-6 bg-white underline underline-offset-8 xss:underline-offset-10 sm:underline-offset-12 md:underline-offset-15 decoration-blue-500 decoration-4">
          <p>Buykeyz</p>
        </div>

        {/* Main Content */}
        <div className="w-full flex flex-col xl:flex-row text-center justify-center items-center xl:items-start py-4 xss:py-6 xs:py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16 2xl:py-20 3xl:py-24 bg-white">
          {/* Image Section */}
          <div className="w-full xl:w-1/2 flex justify-center items-center px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24">
            <Image
              src="/image.png"
              width={550}
              height={250}
              alt="Combine image"
              className="object-contain w-full max-w-[250px] xss:max-w-[280px] xs:max-w-[300px] sm:max-w-[350px] md:max-w-[400px] lg:max-w-[500px] xl:max-w-[500px] 2xl:max-w-[550px] 3xl:max-w-[600px]"
            />
          </div>
          ...
          <div className="w-full xl:w-1/2 flex flex-col justify-start items-start px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-20 3xl:px-24 mt-6 xl:mt-0">
            ...
            <p className="text-[#0D6EFD] text-lg xss:text-xl xs:text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl font-bold mt-4">
              Process we follow for
            </p>
            <p className="text-[#0D6EFD] text-lg xss:text-xl xs:text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl font-bold">
              successful project
            </p>
            <p className="text-[#7B7E86] text-xs xss:text-sm xs:text-sm sm:text-base md:text-base lg:text-lg xl:text-lg 2xl:text-xl 3xl:text-2xl text-start mt-3 pr-4 xss:pr-6 xs:pr-8 sm:pr-10 md:pr-12 lg:pr-14 xl:pr-16 2xl:pr-20 3xl:pr-24">
            ...
            <div className="w-full mt-4">
              <p className="text-[#0D6EFD] text-sm xss:text-base xs:text-base sm:text-lg md:text-lg lg:text-xl xl:text-xl 2xl:text-2xl 3xl:text-3xl font-bold text-start">
                Development Tools We use:
              </p>
              <div className="grid grid-cols-2 xss:grid-cols-6 md:grid-cols-8 lg:grid-cols-8 xl:grid-cols-6 2xl:grid-cols-6 3xl:grid-cols-6 gap-2 xss:gap-3 xs:gap-4 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-6 2xl:gap-8 3xl:gap-10 mt-2">
