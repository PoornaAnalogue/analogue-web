...
export default function Navbar(){
    return (
        <div className='Navbar-main'> 
                 {/* Top Strip */}
              <div className="py-2 px-40 flex justify-between border-b text-xs bg-gray-100 text-black">
                <h1>Time : 24 / 7</h1>
                <p>info@analogueitsolutions.com</p>
              </div>
        
              {/* Navbar */}
              <div className="Navbar bg-white z-50 relative py-1">
                <div className="mx-30 flex justify-between py-2 px-10 items-center shadow-lg">
                  <img src="main-logo.jpg" alt="Logo" className="h-12" />
          ...
          <ul className="flex items-center gap-4">
            {/* Phone Icon */}
            <li>
              <Image src="/phone-icon.jpg" alt="Phone" width={16} height={10} />
            </li>
