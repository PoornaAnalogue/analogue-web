      ...
      <div className="h-full w-full bg-white flex flex-col items-center">
          <div className="flex h-full justify-center relative bg-white h-auto pb-0 mb-0">
            <Image
              ...
              className="object-contain 0 bg-red-500"
            />
        ...
        <div className=" flex justify-center items-center w-full h-full bg-white mx-10 px-15 mt-0 pt-0">
          <div className="border-2 border-red-200 w-1/2 ">
            <Image
              src="/Tech-Adobe.png"
              width={400}
              height={500}
              alt="Adobe Tech image"
              className="object-contain border-2 border-green-300"
            />
          </div>
          <div className="border-2 border-red-200 w-1/2 self-start pt-0 px-10 bg-white">
            ...
            <p className="text-2xl font-weight-400 font-lightbold text-[#0E59F2] p-3 mt-3">We design using Adobe XD</p>
          ...
          <div className="overflow-hidden w-full max-w-6xl py-10">
            <div className="flex w-max animate-scroll gap-4">
              {[
                ...
                // { src: "/Mockup-Image 7.png", alt: "Project 8 screenshot" },
                { src: "/Mockup.png", alt: "Project 8 screenshot" },
                // { src: "/Mockup-Image 8.png", alt: "Project 8 screenshot" },
              ].map((image, index) => (
                <div
                  key={index}
