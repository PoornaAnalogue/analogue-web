...
const TooltipBox = ({ date }) => {
  return (
    <div className=" absolute w-full top-0 left-1/2 -translate-x-1/2 h-auto pointer-events-none ">
      <div className=" text-white bg-[#7794b8] border border-white animate-triangle-path text-xs leading-relaxed flex flex-col items-center gap-1 xs:gap-1  p-1 md:p-3  rounded-xl xss:w-[90px] xs:w-[80px] sm:w-[80px] md:w-[100px] lg:w-[150px] xl:w-[160px] 2xl:w-[170px] 3xl:w-[180px] shadow-md transform-origin-center">
        <div className="font-semibold text-center text-[0.5rem] md:text-xs lg:text-sm mb-0.5 xs:mb-0.5  md:mb-1 ">
          ...
          Free Booking
        <hr className='w-[145] xss:w-[70] xs:w-[60] lg:w-[110] mt-2'/>
        </div>
