...
const TooltipBox = ({ date }) => {
  return (
    <div className=" absolute w-full top-0 left-1/2 -translate-x-1/2 h-auto pointer-events-none ">
      <div className=" text-white bg-[#2D6096] animate-triangle-path text-xs leading-relaxed flex flex-col items-center gap-1 xs:gap-1  p-1 md:p-3  rounded-xl xss:w-[90px] xs:w-[70px] sm:w-[80px] md:w-[100px] lg:w-[150px] xl:w-[160px] 2xl:w-[170px] 3xl:w-[180px] shadow-md transform-origin-center">
        ...
        <p className="text-[0.4rem] sm:text-[0.4rem] md:text-[0.5rem] lg:text-xs xl:text-sm text-center">
          {date.format('dddd')}, {date.format('MMMM D')}<br />
          09:30 AM - 07:00 PM <br />
          Analogue Office
        </p>
