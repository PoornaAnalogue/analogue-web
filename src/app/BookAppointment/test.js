...
const Responsive_CalendarTestPast = () => {
  ...
  return (
    <>
    <div className="xl:pb-30 border-2 border-red-500 bg-white md:px-0 3xl:pb-10 w-full px-6 flex flex-col xl:flex-row h-auto  p-15 xl:gap-10 bg-calendar bg-center bg-cover bg-no-repeat box-border xl:p-0 xl:h-full ">
      <div className="self-center mx-2 xs:mx-3 md:mx-4 lg:mx-6 xl:mx-8 2xl:mx-10 py-2 xl:py-5 flex flex-col gap-2 sm:gap-4 xl:gap-8 w-full xs:w-full sm:w-10/12 md:w-9/12 lg:w-8/12 3xl:py-12 max-w-full">
      ...
      <div className={`self-center w-full mb-3 sm:w-9/12 md:w-8/12 lg:w-8/12 pb-30 max-w-full bg-flower bg-contain bg-no-repeat bg-right `} >
        <div className="min-h-full bg-ellipse bg-contain bg-left bg-bottom bg-no-repeat ">
          <div className="xs:bottom-[20px] xl:right-[50px] xl:bottom-[40px] 2xl:right-[10px] 2xl:bottom-[20px] items-center mx-2 xs:mx-3 sm:mx-4 md:mx-6 lg:mx-8 xl:mx-2 2xl:mx-10 3xl:mx-14 xs:mt-5 sm:mt-6 md:mt-8 xl:mt-15 relative p-1 xs:p-2 sm:p-3 md:p-3  3xl:bottom-[50px] bg-white rounded-md shadow-xl box-border w-[240px] xss:w-[170px] xs:w-[180px] sm:w-[200px] md:w-[240px] lg:w-[260px] xl:w-[280px] 3xl:w-[400px] xs:h-[150px] sm:h-[155px] md:h-[200px] lg:h-[220px] xl:h-[250px] 3xl:h-[360px]">
              ...
              {days.map((day, i) => {
                ...
                return (
                  <div
                    ...
                    className={`text-black md:p-0.5 lg:p-1 rounded-md transition text-[0.5rem] font-semibold md:text-[0.6rem] xl:text-xs 3xl:text-lg
                      ${isSelected ? 'bg-gray-900 text-white' : ''}
                      ${isPast || !isCurrentMonth ? 'text-gray-400 no-custom-cursor cursor-not-allowed' : 'cursor-pointer'}
...
export default Responsive_CalendarTestPast;