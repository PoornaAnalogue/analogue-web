...
function Guarantees() {
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-20 py-10 sm:py-16 bg-white text-gray-800">
      <div className="max-w-6xl mx-auto">
        {/* Main Heading */}
        <h1
          className="
        ...
        {/* Third row - last 2 items */}
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
          {row3.map((item, idx) => (
            <div
              key={idx}
              className={`${item.bg} ${item.textColor} 
