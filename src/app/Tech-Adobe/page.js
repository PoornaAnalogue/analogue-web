      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full bg-white px-4 xss:px-6 xs:px-8 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 pt-0 pb-6">
          <div className="w-full xl:w-3/5 font-medium xl:pl-10">
            <p className="text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] 2xl:text-[1.5rem] 3xl:text-[2rem] font-semibold text-black underline underline-offset-[12px] sm:underline-offset-[16px] decoration-[#0D6EFD] decoration-4 p-2">
              Adobe XD
            </p>
            ...
            <p className="text-xs xss:text-xs sm:text-md md:text-[0.95rem] 2xl:text-base pr-6 text-[#7B7E86] leading-6 pl-3">
          ...
          <div className="carousel-wrapper ">
            <div className="flex w-max animate-scroll gap-2 xs:gap-4 l:gap-8  ">
              {[
                ...
                <div
                  key={index}
                  className="flex justify-end items-center  xss:w-[100px]  sm:w-[120px] xl:min-w-[170px] xss:h-40 xs:h-64 sm:h-72 xl:h-78 bg-white p-3 xss:p-7 md:p-6  xl:px-6     "
                >
                  <Image
                    src={image.src}
                    width={100}
          ...
          <div className="carousel-wrapper overflow-visible">
            <div className="flex w-max animate-scrollLap gap-4 xss:gap-5 xs:gap-6 sm:gap-7 md:gap-8 md-lg:gap-9 lg:gap-10 xl:gap-12 3xl:gap-16  ">
              {[
                ...
                <div
                  key={index}
                  className="flex justify-center items-center min-w-[200px] xss:min-w-[200px] xs:min-w-[240px] sm:min-w-[260px] md:min-w-[300px] md-lg:min-w-[340px] lg:min-w-[300px] xl:min-w-[300px] 3xl:min-w-[340px] h-80 xss:h-88 xs:h-96 sm:h-[26rem] md:h-[28rem] md-lg:h-[27rem] lg:h-[15rem] xl:h-[14rem] 3xl:h-[17rem] bg-white"
                >
                  <Image
                    src={image.src}
                    width={500}
        ...
        <div className="w-full px-4 xss:px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 py-6 sm:py-8">
          ...
          <p className="text-xs xss:text-xs sm:text-md md:text-[0.95rem] 2xl:text-base text-[#7B7E86] leading-6 font-medium">
            Analogue is a Best mobile app development company in Hyderabad that
            specialises in creating and enhancing user experience through the
