...
export default function Responsive_JavaTech() {
  const faqArray = [
    {
      question: "01. What is Java development?",
      answer:
    ...
    {
      question: "02. Why should I choose Java for my application?",
      answer:
    ...
    {
      question:
        "05. Can Java applications be integrated with other technologies?",
      answer:
      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full bg-white px-4 xss:px-4 sm:px-6 md:px-10 lg:px-12 xl:px-8 2xl:px-11 3xl:px-18 pt-0 pb-6">
          <div className="w-full xl:w-3/5 font-medium xl:pl-10">
            ...
            <p className="text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  pr-6 text-[#7B7E86] leading-5 sm:leading-6 pl-3 pb-3">
              Looking for a reliable Java Development Company that blends
              innovation with performance? At Analogue IT Solutions, we harness
              the full potential of Java to craft enterprise-grade applications,
              dynamic web platforms, and secure mobile solutions. Known for its
              platform independence, scalability, and unmatched stability, Java
              empowers businesses to innovate faster and operate smarter.
        ...
        <div className="w-full px-4 xss:px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 py-6 sm:py-8">
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Platform Independence</span> - Java
            follows the principle of “write once, run anywhere,” allowing
            applications to run seamlessly across multiple operating systems.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Robust & Secure</span> - With strong
            memory management and built-in security features, Java provides a
            safe environment for developing enterprise-grade applications.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Scalability</span> - Java applications
            can easily scale from small programs to large enterprise systems,
            making it ideal for growing businesses.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Rich API & Libraries</span> - A vast
            collection of APIs and libraries supports faster development and
            integration with modern technologies.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Community Support</span> - Backed by a
            large developer community, Java offers continuous updates,
            frameworks, and resources for efficient development.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Versatility</span> - Java is used for
            web apps, mobile apps (Android), enterprise solutions, cloud
            computing, and even IoT, making it highly adaptable.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Performance & Reliability</span> -
            With Just-In-Time (JIT) compilation and optimized performance, Java
            applications ensure speed and reliability.
          </p>
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            At Analogue IT Solutions, we don’t just develop applications, we
            build future-ready solutions that drive business growth. As a
            trusted Java Development Company, we combine technical expertise
            with industry insights to deliver secure, scalable, and
            high-performing applications tailored to your needs.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Skilled Java Experts</span> - A team
            of experienced developers proficient in the latest Java frameworks
            and tools.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Custom Solutions</span>{" "}
            - Experience Tailored applications designed to match your business
            goals and challenges.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Enterprise-Grade Security</span> -
            Robust coding practices ensuring data protection and application
            reliability.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Scalable Architecture</span> -
            Solutions that grow seamlessly with your expanding business demands.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">End-to-End Support</span> - From
            strategy and development to deployment and maintenance, we’ve got
            you covered.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            Partner with Analogue IT Solutions and experience the perfect blend
            of innovation, quality, and reliability in Java development
            services.
          </p>
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            Our expert Java development services go beyond just coding,we
            deliver secure, scalable, and highly customized applications
            designed to meet the unique needs of your business. Whether it’s
            building enterprise-grade solutions, enhancing existing systems, or
            creating innovative mobile and web applications, our team leverages
            the full power of Java to drive efficiency, reliability, and
            performance.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            At Analogue IT Solutions, we focus on understanding your business
            goals and translating them into robust software solutions that not
            only solve problems but also create new opportunities for growth.
            Our developers stay ahead of the latest Java frameworks, tools, and
            best practices to ensure your applications are modern, adaptable,
            and future-proof.
          </p>
