...
export default function Home() {
  ...
  return (
    <div className="main !bg-[#FAFBFF]">
      <div className="flex flex-col relative 2xl:min-h-[calc(100vh-64px)] ">
        {/* Hero */}
        <div className="hero flex flex-col xs:flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row !bg-[#FAFBFF] text-black relative">
          {/* Left Hero */}
          <div className="left-hero w-full xl:w-1/2 pt-9 flex flex-col justify-center !bg-[#FAFBFF]">
            <h1 className="text-3xl xs:text-2xl xss:text-xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-4xl 2xl:text-5xl 3xl:text-5xl text-black font-medium leading-tight px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-15">
              Best{" "}
            ...
            <p className="mt-4 text-[#03153A] xl:text-xs xs:text-[0.5rem] 2xl:text-lg sm:text-xs xss:text-xs md:text-base lg:text-1xl xl:text-base 3xl:text-sm px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-15">
              ABOUT OUR COMPANY
            </p>
            <p className="mt-4 text-[#7B7E86] xs:text-[0.5rem] 2xl:leading-relaxed lg:text-sm px-4 xl:text-xs 2xl:text-[1.1rem] 3xl:text-[1rem] sm:text-xs xss:text-xs xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-15">
            ...
            <div className="flex flex-col mt-10 px-4 xs:px-6 sm:px-8 md:px-10 lg:px-12 xl:px-15 xl:mt-[-2]">
              <div className="grid gap-5 w-full xs:w-[20rem] xs:justify-center xs:items-center xs:grid-cols-4 xss:grid-cols-4 xss:gap-2 xss:w-[18rem] 2xl:mt-8 xss:justify-center xss:items-center lg:grid-cols-2 lg:w-[42rem] xl:grid-cols-4 xl:w-[25rem] 2xl:w-[35rem] xl:mb-5 sm:grid-cols-4 sm:w-[25rem] md:grid-cols-2 lg:grid-cols-4">
                {[1, 2, 3, 4].map((id) => (
                  <Image
                    key={id}
                    src={`/ellipse${id}.png`}
              ...
              <span className="flex items-center gap-2 text-gray-700 text-center xss:text-[0.5rem] 2xl:text-[1rem] lg:text-lg xl:text-xs">
                <ShieldCheck className="lg:w-5 lg:h-5 xss:w-3 xss:h-3 xl:w-4 xl:h-4 2xl:h-5 2xl:w-5 text-blue-600" /> 
          ...
          <div className="right-hero w-full xl:w-1/2 flex justify-center 2xl:mt-[-3] xl:mt-[-2] xs:mt-10 md:mt-10 xss:mt-10 items-center relative bg-[url(/Bg-image-of-home-page.png)] bg-cover bg-center bg-no-repeat">
            <div className="relative xs:w-[55%] xss:w-[50%] xs:h-[13rem] sm:w-[90%] sm:h-[15rem] lg:w-[90%] lg:h-[25rem] md:h-[20rem] 2xl:ml-[-0.6rem] 3xl:h-[28rem] xl:w-[80%] xl:h-[22rem] xl: w-[80%] 2xl:h-[25rem] max-w-[400px] aspect-[4/5] flex justify-center items-center">
              <Lottie animationData={animationData} loop={true} style={{ width: "90%", height: "90%" }} />
            </div>

            {/* Left Side Image */}
            <div className="absolute left-2 xs:left-7 xs:w-[6.5rem] xss:left-4 xss:w-[7rem] sm:w-[8.4rem] sm:left-14 md:w-[11rem] md:left-20 lg:w-[12rem] lg:left-28 xl:left-0 xl:w-[11rem] 2xl:w-[13rem] 2xl:left-8 3xl:w-[14rem] 3xl:left-10 top-1/2 -translate-y-1/2 flex flex-col items-center">
              <Image src="/logo12.png" alt="Mobile left image" width={230} height={150} />
            </div>

            {/* Right Side Image */}
            <div className="absolute right-2 xs:right-5 xs:w-[7rem] xss:right-2 xss:w-[7rem] sm:w-[10rem] sm:right-5 md:right-8 lg:w-[14rem] lg:right-16 md:w-[12rem] md:right-15 xl:right-0 xl:w-[11rem] 2xl:w-[14rem] 2xl:right-0 3xl:w-[15rem] 3xl:right-7 top-1/2 -translate-y-1/2 flex flex-col items-center">
