...
//           <div
//             className="w-full md:w-3/4 lg:w-1/2 text-center mb-12 py-12 sm:py-16 bg-[url('/Abstractdesign.png')] bg-no-repeat bg-center bg-cover rounded-lg"
//           >
...
//             <div className="bg-blue-100 p-6 rounded-lg shadow-sm text-center sm:text-left flex-1">
//               <div className="mb-4">
...
//           <div className="bg-blue-100 p-6 rounded-lg shadow-sm text-center sm:text-left">
//             <div className="mb-4">
//               <p className="text-2xl sm:text-3xl font-bold text-[#072060]">
//                 40+
//               </p>
...
//           <div
//             className="absolute right-4 sm:right-6 lg:right-8 -bottom-[70px]"
//           >
//             <Image
...
//                 individuals and organisations to conceptualise and promote
//                 their products. Analogue is a Best mobile in helping businesses
//                 expand and reach their specific customer base by co.
//               </p>
//             </div>
//           </div>
//         </div>
...
export default function AboutPage() {
  ...
  const [projectsRef, projectsInView] = useInView({ triggerOnce: false, threshold: 0.3 });
  const [clientsRef, clientsInView] = useInView({ triggerOnce: false, threshold: 0.3 });
  const [expertsRef, expertsInView] = useInView({ triggerOnce: false, threshold: 0.3 });
    ...
    <>
      <section className="bg-white py-12 px-4 sm:px-6 md:px-8 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-6">
            {/* Successful Projects */}
            <div ref={projectsRef} className="bg-blue-100 p-6 rounded-lg shadow-sm text-center sm:text-left flex-1">
              <div className="mb-4">
                <p className="text-2xl sm:text-3xl font-bold text-[#072060]">
                  {projectsInView ? <CountUp start={1} end={250} duration={2} key={projectsInView ? 'projects' : 'projects'} /> : 0}+
                </p>
                <p className="text-sm text-gray-700 mt-1">Successful Projects</p>
              </div>
              <Image
                src="/aboutimages/processdone.svg"
                alt="Process"
            ...
            {/* Happy Clients */}
            <div ref={clientsRef} className="bg-blue-100 p-6 rounded-lg shadow-sm text-center sm:text-left flex-1">
              <div className="mb-4">
                <p className="text-2xl sm:text-3xl font-bold text-[#072060]">
                  {clientsInView ? <CountUp start={1} end={250} duration={2} key={clientsInView ? 'clients' : 'clients'} /> : 0}+
                </p>
                <p className="text-sm text-gray-700 mt-1">Happy Clients</p>
              </div>
              <Image
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          {/* Skilled Experts */}
          <div ref={expertsRef} className="bg-blue-100 p-6 rounded-lg shadow-sm text-center sm:text-left">
            <div className="mb-4">
              <p className="text-2xl sm:text-3xl font-bold text-[#072060]">
                {expertsInView ? <CountUp start={1} end={40} duration={2} key={expertsInView ? 'experts' : 'experts'} /> : 0}+
              </p>
              <p className="text-sm text-gray-700 mt-1">Skilled Experts</p>
            </div>
            <Image
