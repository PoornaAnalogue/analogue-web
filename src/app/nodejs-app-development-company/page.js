...
export default function Responsive_NodeTech() {
   const faqArray = [
    ...
    {
      question:
        "02. Why should I choose Node.js for my project?",
      answer:
      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full bg-white px-4 xss:px-4 sm:px-6 md:px-10 lg:px-12 xl:px-8 2xl:px-11 3xl:px-18 pt-0 pb-6">
          <div className="w-full xl:w-3/5 font-medium xl:pl-10">
            ...
            <p className="text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  pr-6 text-[#7B7E86] leading-5 sm:leading-6 pl-3 pb-3">
              In today&apos;s digital landscape, a robust and scalable backend is the cornerstone of any successful application. That&apos;s where Node.js, the lightning-fast JavaScript runtime environment, comes into play. Renowned for its speed, efficiency, and event-driven architecture, Node.js enables businesses to deliver high-performing, real-time applications.            
            </p>
        ...
        <div className="w-full px-4 xss:px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 py-6 sm:py-8">
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Real-time magic
              </span> - Build captivating and interactive experiences with Node.js&apos;s event-driven architecture, perfect for chat apps, online games, and more. Keep your users hooked and engaged in real-time!
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Scale with ease</span> - Seamlessly adapt your backend infrastructure to accommodate growing user demands without compromising performance. Node.js scales beautifully, so you can focus on innovation.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Microservices mastery</span> - Break down functionalities into independent microservices for modularity, maintainability, and easier development. Simplify complex applications and enjoy faster development cycles.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">API powerhouse</span> - Create powerful and efficient APIs that seamlessly integrate with your web or mobile app, connecting to diverse data sources and services. Unlock endless possibilities with robust API integrations.
          </p>
          

          <h3 className="text-xl xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium text-[#0E59F2] mb-4 mt-6">
            Unlocking the full power of Node.js takes the right expertise - and that&apos;s exactly what Analogue IT Solutions delivers.          
          </h3>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Backend brilliance</span> - We design and develop high-performance, scalable, and secure backend applications tailored to your specific needs. Our expertise ensures a robust foundation for your digital success.</p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Real-time experts</span> - Leverage our in-depth knowledge of WebSockets, Socket.io, and other tools to craft truly engaging real-time experiences that
 keep your users coming back for more.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Microservices architecture</span> - We design and implement modular microservices architectures for optimal performance, maintainability, and easier future
 updates. Enjoy the benefits of a well-structured and efficient backend.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">API masters</span> - Create well-documented and secure APIs that seamlessly integrate with your various applications and services. Our experts ensure smooth data flow and efficient communication between your systems.
          </p>
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Focus on your core business</span> - Leave the backend intricacies to us while you concentrate on building your application&apos;s frontend or core functionalities. We handle the technical complexities, you handle the magic.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Top talent at your fingertips</span> - Our team comprises highly skilled and certified Node.js developers who stay ahead of the curve with the latest advancements. Benefit from their expertise and dedication to excellence.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
              <span className="font-bold  ">Results-driven approach</span> - We work closely with you to understand your unique needs and deliver solutions that drive real business value. Your success is our priority.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium " >
            <span className="font-bold">Peace of mind guaranteed</span> - Trust that your project is in the hands of experts who prioritise security, scalability, and performance. Relax knowing your backend is in good hands.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium" >
                    Ready to build a phenomenal web presence that engages users and drives growth? Contact Analogue IT Solutions today and unlock a world of possibilities. 
                    We&apos;ll be your trusted partner, guiding you every step of the way to creating a robust and efficient backend that fuels your application&apos;s success.
          </p>
