...
//             <h3 className="NewFont text-2xl text-blue-500 font-medium leading-snug mt-5">We are the best Android App Development Company in Hyderabad, India</h3>
...
//             </div>
//             <div className="mt-15">
//                 <div className="relative h-[400px] w-full bg-[url('/service-icons/app-dev-bg.jpg')] bg-cover bg-center flex justify-end items-center ">
...
//                 <Image src="/service-icons/group-mobiles.png" alt="Group mobiles" width={400} height={400} className="w-full h-full object-cover"/></div>
//                 </div>
//             </div>
...
//                             src={item}
//                             alt={`Icon ${index + 1}`}
//                             width={index === 0 || index >= DesignIcons.length - 2 ? 25 : 50}
//                             height={index === 0 || index >= DesignIcons.length - 2 ? 25 : 50}
//                             className="object-contain"
//                         />
//                         ))}
//                 </div>
        ...
        <div className="hero flex flex-col justify-center items-center">
          ...
          <div className="absolute top-12 xss:top-10 xs:top-10 sm:top-20 md:top-15 bg-white px-4">
            ...
            <div className="px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-16 xl:px-20 flex flex-col space-y-4">
                <h1 className="text-lg xss:text-sm xs:text-xl sm:text-2xl md:text-3xl lg:text-3xl font-semibold underline xs:underline-offset-3 lg:underline-offset-8 xss:underline-offset-1 xs:underline-offset-12 sm:underline-offset-20 md:underline-offset-25 decoration-2 xss:decoration-2 xs:decoration-2 sm:decoration-4 md:decoration-4 lg:decoration-4 decoration-blue-600 leading-snug">Android App Development</h1>
                <h3 className="NewFont text-base xss:text-sm xs:text-sm  sm:text-xl md:text-2xl lg:text-2xl text-blue-500 font-medium leading-snug mt-2 xss:mt-3 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">We are the best Android App Development Company in Hyderabad, India</h3>
                <p className="text-gray-500 leading-relaxed text-xs xss:text-xs xs:text-xs sm:text-sm md:text-base lg:text-base mt-2 xss:mt-1 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">Analogue is a Best mobile app development company in Hyderabad that specialises in creating and enhancing user experience through the design and development of mobile and web applications. Our focus lies in helping businesses expand and reach their specific customer base by collaborating with individuals and organisations to conceptualise and promote their products. Analogue is a Best mobile ain helping businesses expand and reach their specific customer base by co</p>
                <p className="text-gray-500 leading-relaxed text-xs xss:text-xs xs:text-xs sm:text-sm md:text-base lg:text-base mt-2 xss:mt-3 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">Analogue is a Best mobile app development company in Hyderabad that specialises in creating and enhancing user experience through the design and development of mobile and web applications. Our focus lies in helping businesses expand and reach their specific customer base by collaborating with individuals and organisations to conceptualise and promote their products. Analogue is a Best mobile ain helping businesses expand and reach their specific customer base by co. Analogue is a Best mobile app development company in Hyderabad that specialises in creating and enhancing user experience through the design and development of mobile and web applications. Our focus lies in helping businesses expand and reach their specific customer base by collaborating with individuals and organisations to conceptualise and promote their products. Analogue is a Best mobile ain helping businesses expand and reach their specific customer base by co Analogue is a Best mobile app development company in Hyderabad that specialises in creating and enhancing user experience through the design and development of mobile and web applications. Our focus lies in.</p>
            </div>
            ...
            <div className="mt-4 xss:mt-6 xs:mt-8 sm:mt-10 md:mt-12 lg:mt-15">
                            <div className="relative w-full h-auto min-h-[200px] xss:min-h-[250px] xs:min-h-[200px] sm:min-h-[350px] md:min-h-[400px] lg:h-[400px] bg-[url('/service-icons/app-dev-bg.jpg')] bg-cover bg-center flex flex-col lg:flex-row justify-end items-center">
                                <div className="w-full lg:w-[45%] lg:absolute lg:inset-y-0 lg:left-0 p-4 xss:p-6 xs:p-8 sm:p-10 md:p-12 lg:p-11 xl:p-9 2xl:p-10">
                                    ...
                                    <p className="text-white text-xs xss:text-xs xs:text-xs sm:text-sm md:text-sm lg:text-[0.65rem] xl:text-xs 2xl:text-sm leading-loose mt-2 xss:mt-3 xs:mt-4 sm:mt-4 md:mt-5 lg:mt-3 xl:mt-4 2xl:mt-5">At Analogue IT Solutions, we specialise in expert Android app development, employing advanced technologies such as React Native and Flutter. Whether you need a robust e-commerce platform or a tailored mobile solution, our team is dedicated to delivering high-quality Android applications that enhance user experience and drive business success. Trust us to bring your app vision to life with precision and innovation</p>
                                    <button className="bg-blue-700 text-white rounded p-2 xss:p-2 xs:p-2 sm:p-3 md:p-3 lg:p-2 xl:p-2 2xl:p-3 mt-2 lg:mt-6 xss:mt-3 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-2 xl:mt-3 2xl:mt-4 text-xs xss:text-xs xs:text-sm sm:text-sm md:text-sm lg:text-[0.65rem] xl:text-xs 2xl:text-sm">Contact Us</button>
                                </div>
                                <div className="w-full lg:w-[55%] h-[200px] xss:h-[250px] xs:h-[300px] sm:h-[350px] md:h-[400px] lg:h-full">
                                    <Image 
