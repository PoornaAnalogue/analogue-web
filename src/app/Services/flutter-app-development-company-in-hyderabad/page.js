...
const FlutterfaqArray = [
    {
      question:
        "01. What is Flutter App Development?",
      answer:
        ...
        <div className="hero flex flex-col justify-center items-center bg-white pb-12">
          ...
          <div className="absolute top-12 xss:top-10 xs:top-10 sm:top-20 md:top-15 bg-white px-4">
            ...
            <div className="px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-16 xl:px-20 flex flex-col space-y-4 ">
                ...
                <h1 className=" text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] xl:w-[55%] 2xl:w-[45%] font-semibold text-black leading-snug">Best <span className="text-blue-500"> Flutter App Development </span>  Company in Hyderabad, India</h1>
                <p className="text-gray-500 leading-relaxed text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base">Are you searching for a top-notch Flutter app development company in Hyderabad? Look no further! At our company, we bring together a team of highly skilled and passionate Flutter developers who specialize in building high-performing, feature-rich, and visually appealing mobile applications.</p>
                <p className="text-gray-500 leading-relaxed text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base">With a focus on innovation, scalability, and user-friendly design, we create apps that not only meet your business goals but also deliver a seamless experience to your customers. Whether you are a startup looking to launch your first app or an established enterprise aiming to enhance your digital presence, our expertise in Flutter ensures fast development, cost efficiency, and cross-platform compatibility.</p>
            ...
            <div className="mt-4 xss:mt-6 xs:mt-8 sm:mt-10 md:mt-12 lg:mt-15 ">
                            <div className="relative w-full h-auto min-h-[200px] xss:min-h-[250px] xs:min-h-[200px] sm:min-h-[350px] md:min-h-[400px] lg:h-[400px] bg-[url('/service-icons/app-dev-bg.jpg')] bg-cover bg-center flex flex-col lg:flex-row justify-end items-center">
                                <div className="w-full lg:w-[48%] 2xl:w-[50%] lg:absolute lg:inset-y-0 lg:left-0 p-4 xss:p-6 xs:p-8 sm:p-10 md:p-12 lg:p-11 xl:p-9 2xl:p-10">
                                    <h1 className="text-white text-lg xss:text-md xs:text-lg sm:text-xl md:text-xl xl:text-2xl 3xl:text-[1.6rem] font-bold xss:leading-tight 2xl:leading-relaxed">Innovative Flutter App Development for  Your Business</h1>
                                    <p className="text-white text-xs xss:text-xs xs:text-xs sm:text-sm md:text-sm lg:text-[0.75rem] xl:text-sm 3xl:text-base xss:leading-5 xl:leading-7 mt-2 xss:mt-3 xs:mt-4 sm:mt-4 md:mt-5 lg:mt-3 xl:mt-4 2xl:mt-5">At Analogue IT Solutions, we excel in creating cutting-edge Flutter applications designed to work flawlessly across platforms. By harnessing the versatility of Flutter, we deliver apps that are fast, scalable, and visually engaging. From dynamic e-commerce solutions to bespoke mobile applications, our team focuses on crafting products that elevate user experience and drive measurable business results. Partner with us to turn your vision into a powerful Flutter app built with creativity, precision, and innovation.</p>
                                    <button className="bg-blue-700 text-white rounded p-2 xss:p-2 xs:p-2 sm:p-3 md:p-3 lg:p-2 xl:p-2 2xl:p-3 mt-2 lg:mt-4 xss:mt-3 xs:mt-4 sm:mt-4 md:mt-4 lg:mt-2 xl:mt-3 2xl:mt-4 text-xs xss:text-xs xs:text-sm sm:text-sm md:text-sm lg:text-[0.65rem] xl:text-xs 2xl:text-sm"><Link href="/contact">Contact Us</Link></button>
                                </div>
                        ...
                        <div className=" pb-10">
                            ...
                            <h1 className=" text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] font-semibold text-black leading-snug">Flutter App Development Services at Analogue IT Solutions</h1>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 xss:gap-8 xss:px-8 3xl:gap-20 2xl:gap-14 2xl:px-14 3xl:px-30 px-10">
                                <div className=" text-[#7B7E86] p-5 border-l border-r border-gray-200 shadow-[0_4px_2px_rgba(0,0,0,0.3)] bg-white rounded-lg">
                                    <h3 className="font-weight-400 font-semibold text-[#0E59F2] xss:mb-3 xl:text-2xl xl:mb-4 xss:mb-1text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] font-semibold">Cross-Platform Development</h3>
                                    <p className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-7">Flutter enables cross-platform app development with a single codebase for iOS, Android, web, and desktop. This saves time and resources by eliminating the need for separate app development for each platform.</p>
                                </div>
                                <div className=" text-[#7B7E86] p-5 border-l border-r border-gray-200 shadow-[0_4px_2px_rgba(0,0,0,0.3)] bg-white p-6 rounded-lg">
                                    <h3 className="font-weight-400 font-semibold text-[#0E59F2] xss:mb-3 xl:text-2xl xl:mb-4 xss:mb-1text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] font-semibold">Custom UI/UX Design</h3>
                                    <p className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-7">Our Flutter App development services include custom widget development and UI/UX design, ensuring visually appealing and highly functional app interfaces that meet your specific requirements and branding guidelines.</p>
                                </div>
                                <div className=" text-[#7B7E86] p-5 border-l border-r border-gray-200 shadow-[0_4px_2px_rgba(0,0,0,0.3)] bg-white p-6 rounded-lg">
                                    <h3 className="font-weight-400 font-semibold text-[#0E59F2] xss:mb-3 xl:text-2xl xl:mb-4 xss:mb-1text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] font-semibold">Ongoing Support and Maintenance</h3>
                                    <p className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-7">We provide comprehensive ongoing support and maintenance services for Flutter app development, ensuring smooth operations, bug fixes, updates, and continuous improvement to drive success.</p>
                                </div>
                                <div className=" text-[#7B7E86] p-5 border-l border-r border-gray-200 shadow-[0_4px_2px_rgba(0,0,0,0.3)] bg-white p-6 rounded-lg">
                                    <h3 className="font-weight-400 font-semibold text-[#0E59F2] xss:mb-3 xl:text-2xl xl:mb-4 xss:mb-1text-2xl xss:text-[1.1rem] xs:text-[1.2rem] sm:text-[1.3rem] md:text-[1.4rem] xl:text-[1.5rem] 3xl:text-[1.6rem] font-semibold">Integration of Third-Party APIs</h3>
                                    <p className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-7">In Flutter development, we seamlessly integrate native features and third-party APIs, enhancing app capabilities and functionality for a comprehensive and dynamic user experience. App testing, quality assurance, and deployment.</p>
                                </div>
                            </div>
                    ...
                    {/* Why businesses choose flutter */}
                        ...
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Single Codebase - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">Faster deployment for Android & iOS</span></p>
                        </div>
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Cost-Effective Development - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">Save time and resources</span></p>
                        </div>
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Custom Solutions - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">Apps tailored to your business goals</span></p>
                        </div>
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Scalable Performance - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">Reliable under heavy user activity</span></p>
                        </div>
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Engaging Interfaces - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">Smooth, interactive, and modern UI/UX</span></p>
                        </div>
                        <div className="text-[#7B7E86]">
                            <p className="pb-2 text-lg xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium">Dedicated Support - <span className="xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  xss:leading-4 sm:leading-relaxed 3xl:leading-8">End-to-end assistance even after launch</span></p>
                        </div>
                        </div>
                        ...
                        <div className="xl:text-sm text-[#7B7E86] xl:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base leading-relaxed 3xl:leading-8">
                            ...
                            <p className="pb-2">Affordable pricing without compromising quality</p>
                            <p className="pb-2">Proven track record of building apps that engage and perform</p>
                        </div>
                        </div>
                        ...
                        <div className=" text-[#7B7E86] text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base leading-relaxed 3xl:leading-8">
                            <p className="pb-2">Though based in Hyderabad, we proudly deliver Flutter app development services across India and globally. Businesses worldwide trust Analogue for building apps that are not only robust but also tailored to meet unique industry needs.</p>
                        </div>
                        </div>
