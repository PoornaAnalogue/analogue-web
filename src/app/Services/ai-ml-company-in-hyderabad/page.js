        ...
        <div className="hero flex flex-col justify-center items-center bg-white">
          ...
          <div className="absolute top-12 xss:top-10 xs:top-10 sm:top-20 md:top-15 bg-white px-4">
            ...
            <div className="px-4 xss:px-6 xs:px-8 sm:px-10 md:px-12 lg:px-16 xl:px-20 flex flex-col space-y-4">
                <h1 className="text-lg xss:text-md xs:text-lg sm:text-xl md:text-2xl lg:text-2xl 3xl:text-[1.6rem] font-semibold underline xss:underline-offset-6 lg:underline-offset-14 xss:underline-offset-1 text-black xs:underline-offset-12 sm:underline-offset-10 md:underline-offset-15 decoration-2 xss:decoration-2 xs:decoration-2 sm:decoration-4 md:decoration-4 lg:decoration-4 decoration-blue-600 leading-snug">Machine learning and Artificial Intelligence Development</h1>
                <h3 className="NewFont text-base xss:text-[0.8rem] sm:text-base md:text-lg lg:text-xl 3xl:text-2xl text-blue-500 font-medium leading-snug mt-2 xss:mt-3 xs:mt-2 sm:mt-4 md:mt-5 lg:mt-5">We are the best Machine learning and Artificial Intelligence Services in Hyderabad, India</h3>
