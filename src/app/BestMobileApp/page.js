export default function Responsive_Best_App() {
    return (
        <>
            <div className=" w-full h-auto bg-white px-3 py-5 xs:px-4 xs:pt-6 
            sm:px-5 sm:pt-7 md:px-6 md:pt-8 lg:px-8 lg:pt-10 xl:px-10 xl:pt-8"
            >
                <h2 className="text-[#071637] mb-3 font-600 underline decoration-[#0D6EFD] decoration-2 underline-offset-6
                ...
                <div className="  p-1 xs:px-2 sm:px-3 md:px-4 lg:px-5 xl:px-4 ">
                    ...
                    <p className="text-[#7B7E86]  xss:leading-5 sm:leading-6 mb-2 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base">
                    ...
                    <p className="text-[#7B7E86] xss:leading-5 sm:leading-6 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base">
