        ...
        <>
            ...
            >
                ...
                <div className=" p-1 xs:p-2 sm:p-3 md:p-4 lg:p-5 xl:px-4 ">
                    <p className="text-[#0D6EFD] text-sm xs:text-sm sm:text-lg md:text-xl  xl:text-[1.6rem]  font-medium mb-2 xs:mb-3  ">
                        The Best Mobile App Development Company.
                    </p>
                    <p className="text-[#7B7E86] text-[0.625rem] xs:text-[0.55rem]  md:text-xs  xl:text-[1rem]  mb-2 leading-4 xs:leading-5 sm:leading-4 md:leading-5  xl:leading-8 ">
                    ...
                    <p className="text-[#7B7E86] text-[0.625rem] xs:text-[0.55rem] md:text-xs  xl:text-[1rem]  mb-1 xs:mb-2  leading-4 xs:leading-5 sm:leading-4 md:leading-5 xl:leading-8 ">
