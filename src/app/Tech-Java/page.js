...
export default function Responsive_JavaTech() {
  ...
  const scrollLapCarouselRef = useRef(null);

  useEffect(() => {
    const scrollCarousel = scrollCarouselRef.current;
    const scrollLapCarousel = scrollLapCarouselRef.current;
      ...
      <div className="min-h-screen w-full bg-white flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full bg-white px-4 xss:px-6 xs:px-8 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 pt-0 pb-6">
          ...
          <div className="w-full xl:w-2/5 flex justify-center xl:justify-end mb-6 xl:mb-0">
            <Image
              src="/AdobeTech-Images/Java-Tech.png"
              width={400}
              height={450}
        ...
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <div className="carousel-wrapper pt-4 sm:pt-5 overflow-hidden">
            <div ref={scrollCarouselRef} className="flex w-max animate-scroll gap-2 xss:gap-3 xs:gap-4 sm:gap-6">
              {[
          ...
          <div className="carousel-wrapper pt-4 sm:pt-5 overflow-hidden">
            <div ref={scrollLapCarouselRef} className="flex w-max animate-scrollLap gap-4 xss:gap-5 xs:gap-6 sm:gap-7 md:gap-8 md-lg:gap-9 lg:gap-10 xl:gap-12 3xl:gap-16">
              {[
