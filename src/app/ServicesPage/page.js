  ...
  const containers = [
    {
      ...
      bg: "bg-[#4335A7]",
      text: "text-white",
      src: "/ServicePage-Images/serviceImg1.png",
    },
    {
      id: 2,
      ...
      bg: "bg-[#FFF6E9]",
      text: "text-[#03153A]",
      src: "/ServicePage-Images/serviceImg2.png",
    },
    {
      id: 3,
      title: "UI UX Design",
      ...
      bg: "bg-[#8FC7FF]",
      text: "text-[#03153A]",
      src: "/ServicePage-Images/serviceImg3.png",
    },
    {
      id: 4,
      ...
      bg: "bg-[#FF7F3E]",
      text: "text-white",
      src: "/ServicePage-Images/serviceImg4.png",
    },
    {
      id: 5,
      title: "GPS Tracking",
      ...
      bg: "bg-[#072060]",
      text: "text-white",
      src: "/ServicePage-Images/serviceimg5.png",
    },
  ];
            ...
            {containers.map((container, index) => (
              <div
                ...
                className={`${
                  ...
                  index < 4
                    ? `h-auto min-h-[2rem] xss:h-10 sm:h-13 md:h-16 lg:h-15 xl:h-19 ${
                        expandedContainer === container.id
                          ? "min-h-[16rem] xss:min-h-[17rem] xs:min-h-[18rem] sm:min-h-[19rem] md:min-h-[21rem] xl:min-h-[19rem]"
                          : ""
                      } hover:h-auto hover:min-h-[16rem] xss:hover:h-[17rem] xs:hover:h-[18rem] sm:hover:h-[19rem] md:hover:h-[21rem] xl:hover:h-[19rem] cursor-pointer`
