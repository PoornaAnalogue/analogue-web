...
export default function Puzzle() {
  ...
  const styles = (index) => {
    switch (index) {
      case 0: return { top: 0, left: 2 };
      case 1: return { top: 30, left: 95 };
      case 2: return { top: 0, left: 190 };
      case 3: return { top: 95, left: -30 };
      case 4: return { top: 125, left: 65 };
      case 5: return { top: 95, left: 160 };
      case 6: return { top: 190, left: 0 };
      case 7: return { top: 220, left: 95 };
      case 8: return { top: 190, left: 190 };
      default: return {};
    }
  };
          ...
          <AnimatePresence key={step.id}>
            {idx < stepIndex && (
              <motion.img
                ...
                style={{
                  ...styles(idx),
                  left: `${styles(idx).left + (typeof window !== 'undefined' && window.innerWidth < 768 ? 10 : 0)}px`,
                }}
              />
            )}
          </AnimatePresence>
