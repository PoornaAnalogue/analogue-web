...
export default function Responsive_PyTech() {
  const faqArray = [
    {
      question: "01. What types of applications can you build using Python?",
      answer:
    ...
    {
      question: "02. Why should I choose Python for app development?",
      answer:
    ...
    {
      question: "03. Do you provide custom Python app development services?",
      answer:
    ...
    {
      question:
        "05. Can you integrate Python applications with third-party tools and APIs?",
      answer:
    ...
    <>
      <div className="min-h-screen w-full bg-white flex flex-col items-center">
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-full bg-white px-4 xss:px-4 sm:px-6 md:px-10 lg:px-12 xl:px-8 2xl:px-11 3xl:px-18 pt-0 pb-6">
          <div className="w-full xl:w-3/5 font-medium xl:pl-10">
            ...
            <p className="text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  pr-6 text-[#7B7E86] leading-5 sm:leading-6 pl-3 pb-3">
              Are you searching for the Best Python Development Company to take
              your business to the next level? Look no further than Analogue IT
              Solutions. Our team of skilled and experienced developers
              specialises in providing top-notch Python development services
              that are tailored to meet your unique business needs.
            </p>
            <p className="text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base  pr-6 text-[#7B7E86] leading-5 sm:leading-6 pl-3">
              Python is a versatile and sophisticated programming language that
              is commonly used in web development, data analysis, artificial
        ...
        <div className="w-full px-4 xss:px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 py-6 sm:py-8">
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Simplified Development</span> - With
            its clean and easy-to-understand syntax, Python accelerates coding
            and reduces development complexities.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Limitless Flexibility</span> - Whether
            it&apos;s web apps, mobile solutions, data science, or AI/ML
            projects, Python proves effective in every domain.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Rich Ecosystem</span> - Tap into a
            massive collection of libraries and frameworks that boost efficiency
            while maintaining top-notch quality.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Scalable & Future-Ready</span> -
            Python supports building solutions that grow with your business,
            ensuring long-term sustainability.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Open-Source & Community Support</span>{" "}
            - Backed by a global community, Python offers cost-effective
            solutions with continuous enhancements and reliable support.
          </p>
          ...
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Python Web Development</span> - Our
            Python Web Development Services use cutting-edge technologies to
            build powerful and scalable online applications that match our
            clients&apos; business requirements.{" "}
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Python Mobile App Development</span> -
            Our Python Mobile App Development Services help businesses to
            develop high-performance, user-friendly mobile apps that meet the
            specific needs of their clients.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Enterprise software solutions</span> -
            Python is used in our Enterprise Software Solutions to construct
            sophisticated, customised web apps that improve productivity and
            workflow efficiency.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            ...
            - Our custom Python development solutions are tailored to your
            company&apos;s specific demands, providing scalable, cost-effective
            solutions that produce tangible results.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">
              Python data analysis and visualisation
            </span>{" "}
            - Our Python data analysis and visualisation services help
            businesses use big data to make better decisions by providing
            interactive dashboards and deeper insights.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">AI/ML solutions</span> -  Our
            Python-based AI and machine learning solutions enable businesses to
            automate operations, generate important insights, and enhance
            consumer experiences.
          </p>

          <h3 className="text-xl xss:text-sm  sm:text-base md:text-lg 2xl:text-[1.2rem] font-medium text-[#0E59F2] my-4 mt-6">
            At Analogue IT Solutions, we harness the full potential of Python to
            develop robust, scalable, and high-performing applications that
            drive business growth and success.Below are common procedure we
            follow:
          </h3>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Expertise</span> - Our team of
            developers has in-depth knowledge and expertise in Python
            programming, ensuring that your project is in the best hands.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Custom Solutions</span> - We recognize
            that each business is unique. That&apos;s why we work closely with
            our clients to create custom Python solutions that align with their
            specific business objectives.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            <span className="font-bold  ">Quality Assurance</span> - We uphold
            the highest standards of quality in our development process,
            ensuring that the final product is thoroughly tested and meets your
            expectations.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium ">
            <span className="font-bold">Timely Delivery</span> - We are
            committed to delivering your Python development project on time,
            without compromising on quality.
          </p>
          <p className="pb-3 text-xs xss:text-xs sm:text-sm lg:text-subbody 3xl:text-base text-[#7B7E86] leading-5 sm:leading-6  font-medium">
            Partnering with AnalogueIT Solutions for Python development means
            gaining a competitive edge and staying ahead in today&apos;s
            fast-paced business environment. Contact us today to discuss how our
            Python development services can unlock new opportunities for your
            business
          </p>
