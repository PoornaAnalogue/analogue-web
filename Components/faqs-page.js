...
export default function FrequentQuestions({ Question }) {
  ...
  return (
    <div className=" mx-auto 2xl:mt-3 md:mt-5 w-[100%] pb-3 xss:mt-5">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="xss:text-subsmall sm:text-xs lg:text-sm pt-2 text-gray-500 xss:pb-2 sm:pb-4 text-start">
          In case, you aren&apos;t able to find your answer, do write to us
          ...
          >
            ...
            <div className="w-full">
              ...
              >
                ...
                <span className="text-2xl xss:pr-2 lg:pr-5 text-black">
                  {openFaqIndex === index ? "-" : "+"}
                </span>
              </button>
            </div>
