...
//           {/* Close Button */}
//           <button onClick={(e) => { e.stopPropagation(); e.preventDefault(); onClose();}}
//             type="button" className="absolute top-3 right-3 text-gray-700 hover:text-black focus:outline-none">✕</button>
