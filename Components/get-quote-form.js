...
export default function GetAQuoteForm() {
  ...
  const inputClasses =
    "bg-transparent border-b border-gray-800 focus:outline-none text-gray-800 placeholder-black text-xs py-2 w-full";
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-5xl rounded-3xl min。由min-h-[600px] xl:min-h-[700px] 2xl:min-h-[800px] flex flex-col justify-center items-center z-10">
        ...
        {/* Glassmorphic Form */}
        <div className="relative z-20 xl:p-6 2xl:p-4 xl:mt-[-2.7rem] 2xl:mt-[-2.3rem] 3xl:mt-[-1.5rem] xss:mt-[-2.3rem] xs:mt-[-2.2rem] sm:mt-[-2.4rem] md:mt-[-2rem] lg:mt-[-2.5rem] w-full p-5 border-gray-300 border-2
  ...
  <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-hide scrollbar-track-transparent pr-2">
    <form
      onSubmit={handleSubmit}
      className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-2 3xl:gap-5 xs:gap-2"
    >
      ...
      <div className="flex flex-col">
        <input
          ...
          className={`bg-transparent border-b border-gray-800 focus:outline-none text-gray-800 text-xs placeholder-black py-2 h-10 ${
            isError("name")
      ...
      <div className="md:col-span-2 flex flex-col">
        <textarea
          ...
          onChange={handleChange}
          onBlur={handleBlur}
          className={`bg-transparent border-b scrollbar-hide min-h-[3rem] max-h-[300px] focus:outline-none text-gray-800 text-xs placeholder-black py-2 w-full ${
            isError("message")
              ? "border-red-500 text-red-600"
              : "border-gray-800"
          }`}
