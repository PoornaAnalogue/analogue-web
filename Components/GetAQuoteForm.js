...
const handleSubmit = (e) => {
  ...
  return (
    <div className="main-container min-h-[600px] xl:min-h-[700px] 2xl:min-h-screen relative flex flex-col items-center justify-center rounded-lg px-4 xl:mt-[-6rem] 3xl:mt-[-3rem] xs:px-6 xss:py-10 xl:pb-8 sm:px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-20">
...
<div>
            ...
            <div className="md:col-span-2 flex flex-col gap-2">
              {/* Row 1: Captcha text */}
              <span className="px-4 py-2 bg-white rounded-md font-mono xss:text-sm lg:text-lg w-fit tracking-widest">
                {captcha}
              </span>
