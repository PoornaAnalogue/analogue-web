...
export default function PopUpForm({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      {/* Modal Container */}
      {/* Modal Container */}
<div className="relative text-xl p-2 w-full max-w-[330px] lg:max-w-[720px] 2xl:w-[600px] 2xl:h-[75vh] 2xl:w-[720px] 3xl:max-h-[82vh] max-h-[82vh] overflow-hidden rounded-3xl shadow-lg bg-gradient-to-br from-blue-100 via-pink-50 to-gray-100 flex flex-col">
  {/* Form Content */}
  <div className="relative p-2 md:p-10 2xl:p-1 3xl:p-6 2xl:px-8 xss:px-5 flex-1 flex flex-col">
    {/* Close Button */}
    <button
      onClick={(e) => {
        e.stopPropagation();
    ...
    <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent pr-2">
      <form onSubmit={handleSubmit}
        className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-2 2xl:gap-2 3xl:gap-5 xs:gap-2">
        ...
        <div className="flex flex-col">
          <input
            ...
            onBlur={handleBlur}
            className={`bg-transparent border-b border-gray-800 focus:outline-none text-gray-800 text-xs placeholder-black py-2 h-10 w-full ${
              isError("name")
        ...
        <div className="flex flex-col">
          <div className="h-10 flex items-center">
            <PhoneInput
              ...
              enableSearch={true}
              inputClass="!bg-transparent !border-none !focus:outline-none !text-xs !w-full !pl-12 !text-gray-800 placeholder-black !h-full"
              buttonClass="!bg-transparent !border-none !outline-none !h-full"
              containerClass={`!border-b !w-full !h-full ${
                touched.phone &&
                formData.phone &&
        ...
        <div className="md:col-span-2 flex flex-col">
          <textarea
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className={`bg-transparent border-b resize-vertical min-h-[3rem] max-h-[200px] focus:outline-none text-gray-800 text-xs placeholder-black py-2 w-full ${
              isError("message")
                ? "border-red-500 text-red-600"
                : "border-gray-800"
            }`}
        ...
        <div className="md:col-span-2 flex flex-col gap-2">
          ...
          <input
            ...
            className={`border-b bg-transparent focus:outline-none text-xs text-gray-800 placeholder-black py-2 xss:w-1/2 md:w-1/4 xl:w-1/8 ${
              captchaError ? "border-red-500 text-red-600" : "border-gray-800"
            }`}
          />
        ...
        <div className="col-span-1 md:grid-cols-2 flex justify-start mt-2 mb-4">
          <button
            type="submit"
